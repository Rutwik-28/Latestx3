  ...
  <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand" href="homepage.php"><img src="img/cricketlogo.png" alt="logo"></a>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 text-center">
          ...
          <p class="lead">Login to your account by going through a simple registration Form. </p>
          <p class="lead">With the sets of your skills. The sccouting team will put you in the rigth team.You will get a notified message of your confirmation in team.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="section" id="contact">
    <div class="container">
      <div class="col-md-12">
        ...
        <h1 class="size-50">Contact Us</h1>
        <div class="h-50"></div>
      </div>
      <div class="col-md-4" data-aos="fade-up">

        <h3>Mobile Number</h3>
        <a href="tel:+918208050250">
          <p>+91 8208050250</p>
        </a>
        <h3>Email</h3>
        <a href="mailto:rutwikkarande28@gmail.com">
          <p>rutwikkarande28@gmail.com</p>
        </a>
        <h3>Address</h3>
        <a href="https://goo.gl/maps/zTMk2ruBv2r" target="_blank">
          <p>Pune</p>
        </a>
